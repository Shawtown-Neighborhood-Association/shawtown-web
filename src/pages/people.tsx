          ...
          <div className="row">
            <div className="col-sm">
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                <Person name="Brad Candell" title="President" residentSince={1979}>
                  This is the biography
                </Person>
                <Person name="Aram Mann-Whitcombe" title="Vice President">
                  This is the biography
                </Person>
                <Person name="Cindy Schlosser" title="Treasurer">
                  This is the biography
                </Person>
                <Person name="Tim Solfest" title="Secretary">
                  This is the biography
                </Person>
                <Person name="Drew Kaiser" title="Director of Information &amp; Communications">
                  This is the biography
                </Person>
              </div>
            </div>
